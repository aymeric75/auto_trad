...
def run_vae_pipeline(dataset_name: str, vae_type: str):
    ...
    #"trend_poly": 0, "latent_dim": 10, "reconstruction_wt": 3, "batch_size": 8

    # vae_model.trend_poly = 0
    # vae_model.latent_dim = 10
    # vae_model.reconstruction_wt = 3
    # vae_model.batch_size = 8
